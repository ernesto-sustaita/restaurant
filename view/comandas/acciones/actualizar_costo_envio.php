...
if(isset($_POST['idComanda']) && $_POST['idComanda'] != '' && isset($_POST['costoEnvio']) && $_POST['costoEnvio'] != ''){  
    if(ComandasController::actualizarCostoEnvio($_POST['idComanda'], $_POST['costoEnvio'])){
        echo true;
    } else {
        echo false;
    }
