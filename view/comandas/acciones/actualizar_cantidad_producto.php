...
if(isset($_POST['idComanda']) && $_POST['idComanda'] != '' && isset($_POST['idProducto']) && $_POST['idProducto'] != '' && isset($_POST['cantidad']) && $_POST['cantidad'] != ''){
    
    if(ComandasController::actualizarCantidadProducto($_POST['idComanda'], $_POST['idProducto'], $_POST['cantidad'])){
        echo true;
    } else {
        echo false;
    }
