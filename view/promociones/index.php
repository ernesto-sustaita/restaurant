      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAgregarLabel">Agregar promoción</h5>
            ...
            <div class="modal-body">
            	...
            	<div id="primera-parte">
                    <div class="mb-3">
              		...
              		<div class="mb-3">
              			<label class="form-label obligatoria" for="selectAgregarTipo">Tipo*:</label>
                		<select id="selectAgregarTipo" class="form-select" onchange="activarBoton('#botonGuardar')">
                          <option selected="selected" value="">Seleccionar</option>
                          <option value="1">Porcentaje</option>
                          <option value="2">Precio fijo</option>
                          <option value="3">2 x 1</option>
